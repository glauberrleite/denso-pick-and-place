...
class invKine:
    ...
    def command_recieve(self,transform_data):
        ...
        self.thetas[1] = np.arctan2(z,w)*np.arccos((w**2 + z**2 + self.l[0]**2 - self.l[1]**2)/(2*self.l[1]*np.sqrt(w**2 + z**2)))
        self.thetas[2] = np.arccos((w**2 + z**2 - self.l[0]**2 - self.l[1]**2)/(2*self.l[1]*self.l[2]))
